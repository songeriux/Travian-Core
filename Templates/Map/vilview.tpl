...
?>
    ...
    <table cellpadding="1" cellspacing="1" id="village_info" class="tableNone">
        ...
        <tbody><tr>
            <th>Tribe</th>
            <td><?php switch($uinfo['tribe']) { case 1: echo TRIBE1; break; case 2: echo TRIBE2; break; case 3: echo TRIBE3; break; case 4: echo TRIBE4; break; case 5: echo TRIBE5; break; case 6: echo TRIBE6; break;} ?></td>
        </tr>
        <tr>
            <th>Alliance</th>
      ...
      if($cps >= $need_cps) {
        ...
        <tr>
          ...
          $data2 = mysql_fetch_assoc($query2);
           if($data2['access']=='0') {
            echo "&raquo; Send troops. (Player Banned)";
