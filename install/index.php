...
<head>
    <title>Travian Core Installation</title>
    ...
    <div class="wrapper">
        ...
        <div id="mid">
            <div id="side_navi">
				...
				<span class="f18 c5">Travian Core Installation Script</span>
				</center></div>
        ...
        <div id="footer">
            <div class="footer-menu c3" id="mfoot">
                ...
                <div class="copyright">
                    &copy; 2012 Travian Core All rights reserved
                </div>

                <div class="copyright">
                    Server running on: <b><font color="red">v0.1</font></b>
                </div>
            </div>
